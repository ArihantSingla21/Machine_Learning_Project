...
# - sklearn.compose: Composing transformers
# - sklearn.pipeline: Machine learning pipeline construction
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''
        main aim is to transform any kind of data for model training and processing 
        '''
        try:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("applying data transformation on training and testing dataframe")
